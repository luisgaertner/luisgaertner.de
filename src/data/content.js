...
export const PROJECTS = {
  de: [
    ...
    { text: '' },
    { text: '  [03]  WindowAnchor', color: 'green' },
    { text: '        Workspace-Manager für Windows — speichert und', color: 'dim' },
    { text: '        stellt Fensterlayouts automatisch wieder her.', color: 'dim' },
    { text: '        Stack: C#, .NET, WPF', color: 'cyan' },
    { text: '        → https://github.com/luisgaertner/WindowAnchor', color: 'blue', link: 'https://github.com/luisgaertner/WindowAnchor' },
    { text: '' },
    { text: '  [04]  Blitztext', color: 'green' },
    { text: '        macOS Speech-to-Text App mit konfigurierbaren', color: 'dim' },
    { text: '        Hotkeys und lokalem Whisper-Modus.', color: 'dim' },
    { text: '        Stack: Swift, WhisperKit, OpenAI API', color: 'cyan' },
    { text: '        → https://github.com/luisgaertner/blitztext-app', color: 'blue', link: 'https://github.com/luisgaertner/blitztext-app' },
    { text: '' },
    { text: '  [05]  luisgaertner.de', color: 'green' },
  ...
  en: [
    ...
    { text: '' },
    { text: '  [03]  WindowAnchor', color: 'green' },
    { text: '        Workspace manager for Windows — saves and', color: 'dim' },
    { text: '        restores window layouts automatically.', color: 'dim' },
    { text: '        Stack: C#, .NET, WPF', color: 'cyan' },
    { text: '        → https://github.com/luisgaertner/WindowAnchor', color: 'blue', link: 'https://github.com/luisgaertner/WindowAnchor' },
    { text: '' },
    { text: '  [04]  Blitztext', color: 'green' },
    { text: '        macOS speech-to-text app with configurable', color: 'dim' },
    { text: '        hotkeys and local Whisper mode.', color: 'dim' },
    { text: '        Stack: Swift, WhisperKit, OpenAI API', color: 'cyan' },
    { text: '        → https://github.com/luisgaertner/blitztext-app', color: 'blue', link: 'https://github.com/luisgaertner/blitztext-app' },
    { text: '' },
    { text: '  [05]  luisgaertner.de', color: 'green' },
...
export const HELP = {
  de: [
    ...
    { text: '  game        🎮 DoodleJump spielen', color: 'green', command: 'game' },
  ...
  en: [
    ...
    { text: '  game        🎮 Play DoodleJump', color: 'green', command: 'game' },
...
export const PROJECT_LINKS = [
  ...
  'https://github.com/luisgaertner/WindowAnchor',
  'https://github.com/luisgaertner/blitztext-app',
